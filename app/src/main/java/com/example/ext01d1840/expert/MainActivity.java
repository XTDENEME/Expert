                   ...
                   xtSisLogin.OnFragmentInteractionListener
{
   ...
   public void onBackPressed() {
       ...
       if (name=="Haberler"){
           ...
           //Haberler sayfasına gelindiğinde tamamen çıkış için eklendi
           ...
           if (getSupportFragmentManager().getBackStackEntryCount() != 1)
               ...
               //Programdan tamamen çıkış için eklendi
               Intent intent = new Intent(Intent.ACTION_MAIN);
               intent.addCategory(Intent.CATEGORY_HOME);
               intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
               startActivity(intent);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (loginstatus == false)
            menu.findItem(R.id.settingLogin).setTitle("Sisteme Giriş");
        else if (loginstatus == true)
            menu.findItem(R.id.settingLogin).setTitle("Çıkış");
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item ) {
        ...
        if (id == R.id.action_settings) {
            ...
            if (loginstatus == true){
                ...
                global.setCheckLogin(false);
                item.setTitle("Sisteme Giriş");
            }
